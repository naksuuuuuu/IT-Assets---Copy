...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../user/mod.php">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="display nowrap" id="dataTable1" width="100%" cellspacing="0">
                                        ...
                                        <tbody id="doc_tbody">
                                            <?php
                                                $sql = "SELECT DISTINCT A.DOCUMENT_NO, A.PO_NUMBER, A.DOCUMENT_DATE, A.DEPARTMENT_CODE, B.MTRL_SHORT, 
                                                ...
                                                oci_execute($query);
                                                    while ($row = oci_fetch_assoc($query)) {
                                                        echo"<tr>
                                                            <td><img id='plusImg' class='mod_po' src='../../assets/add-free-icon-font.png'></td>
                                                            <td style='width: 200px'>".$row["DOCUMENT_NO"]."</td>
                                                            <td style='width: 200px'>".$row["PO_NUMBER"]."</td>
                                                            <td style='width: 200px'>".$row["DOCUMENT_DATE"]."</td>
