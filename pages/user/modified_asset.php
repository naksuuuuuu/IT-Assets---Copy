...
<head>
    ...
    <title>ITAMS - Modified Asset</title>
            ...
            <div id="content">
                ...
                <form method='POST' enctype='multipart/form-data' id='srch_Form'>
                    ...
                    <div class="card-header" style="background-color: #4e73df;">
                        <h2 class="m-0 font-weight-bold" style="color: white; text-align: center">Modified Asset</h2>
                    </div>
                    <br>
...
<script>
    ...
    $("#srch").click(function(){
        ...
        if (po_num != "" && emp_name == "" && brand == "" && dept == "" && vendor == "" && from_date == "" && to_date == "" 
            ...
            $.ajax({
                type: "POST",
                url: "../../logic/history/modified_asset.php",
