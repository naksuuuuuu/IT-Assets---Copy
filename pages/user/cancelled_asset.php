                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-select" name="ser_no1" id="ser_no1" style="margin-bottom: 8px;">
                                                    <option value=""></option>
                                                    <?php 
                                                        $sql = "SELECT DISTINCT SERIAL_NO1 FROM IT_ASSET_DETAILS WHERE CANCEL_ASSET_FLAG is not null";
                                                        $res = oci_parse(connection(), $sql);
                                                        oci_execute($res);
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-select" name="rem" id="rem" style="margin-bottom: 8px;">
                                                    <option value=""></option>
                                                    <?php 
                                                        $sql = "SELECT DISTINCT REMARKS FROM IT_ASSET_DETAILS WHERE CANCEL_ASSET_FLAG is not null";
                                                        $res = oci_parse(connection(), $sql);
                                                        oci_execute($res);
